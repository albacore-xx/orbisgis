...
import org.orbisgis.core.ui.views.geocatalog.newSourceWizards.db.ConnectionPanel;
import org.orbisgis.core.ui.views.geocatalog.newSourceWizards.db.TableSelectionPanel;
...
public class NewGeocognitionDB extends AbstractPlugIn {
	...
	public void initialize(PlugInContext context) throws Exception {
		...
		context.getFeatureInstaller().addPopupMenuItem(frame, this,
				new String[] { "Add", "Database source" }, "Add", false,
				getIcon("database_add.png"), wbContext);
	}
