...
public abstract class WorkbenchContext extends Observable{
	...
	public void setLastAction(String lastAction){
		...
		System.out.println(" Event : "+lastAction + ", WorkbenchContext update finished--------------------------");		
	}
	
	public void setRowSelected(MouseEvent e){
		setChanged();
		notifyObservers(e);
		System.out.println("MouseEvent : on " + e.getSource() + ", WorkbenchContext update finished--------------------------"); 
	...
	public void setHeaderSelected(int  selectedColumn) {
		...
		System.out.println("------------------------------WorkbenchContext update finished--------------------------"); 
		setChanged();
