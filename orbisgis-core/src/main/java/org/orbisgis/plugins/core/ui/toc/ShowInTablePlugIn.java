...
public class ShowInTablePlugIn extends AbstractPlugIn{	
	...
	public boolean execute(PlugInContext context) throws Exception {
		...
		final MapContext mapContext = context.getWorkbenchContext().getWorkbench().getFrame().getToc().getMapContext();
	...
	public void initialize(PlugInContext context) throws Exception {
    	...
    	context.getFeatureInstaller().addPopupMenuItem(frame, this,  
    			new String[] {Names.POPUP_TOC_TABLE_PATH1}, Names.POPUP_TOC_TABLE_GROUP, 
    			false, getIcon(Names.POPUP_TOC_TABLE_ICON), wbContext);
	}
