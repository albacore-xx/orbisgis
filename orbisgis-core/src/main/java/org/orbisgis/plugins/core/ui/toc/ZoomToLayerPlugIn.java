...
public class ZoomToLayerPlugIn extends AbstractPlugIn {
    ...
    public boolean execute(PlugInContext context) throws Exception {
		MapContext mapContext = context.getWorkbenchContext().getWorkbench().getFrame().getToc().getMapContext();
		...
		IEditor[] editors = em.getEditors("Map",
				mapContext);
	...
	public void initialize(PlugInContext context) throws Exception {		
    	...
    	context.getFeatureInstaller().addPopupMenuItem(frame, this,  
    			new String[] {Names.POPUP_TOC_ZOOM_PATH1}, Names.POPUP_TOC_ZOOM_GROUP, 
    			false, getIcon(Names.POPUP_TOC_ZOOM_ICON), wbContext);		
	}
