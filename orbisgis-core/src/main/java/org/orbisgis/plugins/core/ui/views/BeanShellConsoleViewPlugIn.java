...
import org.orbisgis.core.ui.views.beanShellConsole.CompletionKeyListener;
...
/*		JavaManager javaManager = Services.getService(JavaManager.class);
		...
		ClassLoader classLoader = BeanShellConsoleViewPlugIn.class.getClassLoader();
		...
		menuItem = context.getFeatureInstaller().addMainMenuItem(this,
				new String[] { "View" }, "Beanshell", true,
				getIcon("page_white_cup.png"), null, panel, 
	...
	private void eval(String text) {
		...
		try {
			...
			interpreter.getNameSpace().importCommands(
					"org.orbisgis.core.ui.views.beanShellConsole.commands");
