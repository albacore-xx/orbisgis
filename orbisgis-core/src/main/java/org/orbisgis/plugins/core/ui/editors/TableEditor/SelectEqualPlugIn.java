...
public class SelectEqualPlugIn  extends AbstractPlugIn {	
	...
	public boolean execute(PlugInContext context) throws Exception {
		...
		final int rowIndex = ((TableComponent)editor.getView().getComponent()).getTable().rowAtPoint(event.getPoint());
		final int columnIndex = ((TableComponent)editor.getView().getComponent()).getTable().columnAtPoint(event.getPoint());
