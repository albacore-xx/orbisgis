...
public class SQLConsoleViewPlugIn extends ViewPlugIn {
	...
	private static final Logger logger = Logger.getLogger(SQLConsoleViewPlugIn.class);
	...
	public SQLConsoleViewPlugIn() {
	 ...
	 public void initialize(PlugInContext context) throws Exception {
		 ...
		 menuItem = context.getFeatureInstaller().addMainMenuItem(this, new String[] { "View" }, 
				 "SQL Console", true, getIcon("script_code.png"), null, panel, context.getWorkbenchContext());
	 }
