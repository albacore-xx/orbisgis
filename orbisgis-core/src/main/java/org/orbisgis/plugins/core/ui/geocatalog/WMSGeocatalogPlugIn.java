...
import org.orbisgis.core.ui.views.geocatalog.newSourceWizards.wms.LayerConfigurationPanel;
import org.orbisgis.core.ui.views.geocatalog.newSourceWizards.wms.SRSPanel;
import org.orbisgis.core.ui.views.geocatalog.newSourceWizards.wms.WMSConnectionPanel;
...
public class WMSGeocatalogPlugIn extends AbstractPlugIn {
	...
	public void initialize(PlugInContext context) throws Exception {
		...
		context.getFeatureInstaller().addPopupMenuItem(frame,this,
				new String[] { "Add", "WMS Source" }, "Add", false,
				getIcon("server_connect.png"), wbContext);
	}
