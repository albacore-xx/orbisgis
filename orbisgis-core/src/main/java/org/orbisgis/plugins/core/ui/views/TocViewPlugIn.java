...
public class TocViewPlugIn extends ViewPlugIn {
	...
	public TocViewPlugIn() {
	 ...
	 public void initialize(PlugInContext context) throws Exception {
		 ...
		 panel = new Toc();	
		 //setComponent(panel,"Memory", getIcon("utilities-system-monitor.png"), context);
		 menuItem = context.getFeatureInstaller().addMainMenuItem(this, new String[] { "View" }, 
				 "Toc", true, getIcon("map.png"), editors , panel, context.getWorkbenchContext());
	 }
	...
	public void editorViewDisabled() {
		//TODO : TOC is not available after one editor is closed. Except that if it stays only one editor in EditorPanel.
		// In this case Toc context is updated. But upper 2 editors the previous editor is not updated		
