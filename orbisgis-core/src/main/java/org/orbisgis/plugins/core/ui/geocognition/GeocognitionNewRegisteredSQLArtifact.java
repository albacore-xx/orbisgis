...
public class GeocognitionNewRegisteredSQLArtifact extends AbstractPlugIn {	
	...
	public boolean execute(PlugInContext context) throws Exception {
		getUpdateFactory().executeGeocognitionElement(new NewRegisteredSQLArtifact());
		return true;
	}
	...
	public void initialize(PlugInContext context) throws Exception {
		...
		context.getFeatureInstaller().addPopupMenuItem(frame, this,
				...
				Names.POPUP_GEOCOGNITION_REG_SQL_PATH1}, Names.POPUP_GEOCOGNITION_REG_SQL_GROUP, false,
