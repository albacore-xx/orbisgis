...
import org.orbisgis.core.ui.configurations.ProxyConfiguration;
...
public class EPConfigHelper {
	 ...
	 */
	//TODO : mettre sous forme de plugin
	public static ArrayList<ConfigurationDecorator> getConfigurations() {		
		if (configs == null) {			
			...
			configs.add(new ConfigurationDecorator(new RenderingConfiguration(), 
					"org.orbisgis.core.ui.RenderingConfiguration", 
					"Rules","org.orbisgis.core.ui.RenderingConfiguration"));			
		}
	...
	public static IMenu getConfigurationMenu() {		
		...
		Menu m1 = new Menu(null,"org.orbisgis.core.ui.Updates", null, "WWW", null, null);
		menuTree.addMenu(m1);
		Menu m2 = new Menu(null,"org.orbisgis.core.ui.RenderingConfiguration", null, "Rendering", null, null);
		menuTree.addMenu(m2);
